...
{ quoted : m }) 
  ...
  } else reply('Mode itu tidak ada cuy!')
  ...
  case 'menu2':{  
   ...
   let buttonss = [{
     index: 1, 
      urlButton: {
       displayText: '𝚈𝙾𝚄𝚃𝚄𝙱𝙴', 
       url: 'https://youtube.com/channel/UCAXHJebpkyPVs20poWdo_Zw'
       } 
     },     
     {
      index: 1, 
       ...
       url: 'https://www.instagram.com/xyyz_nomercy'
       }
       }, 
       {
       index: 1, 
